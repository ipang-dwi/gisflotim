			...
			<?php if($this->session->userdata('jt')=='admin' || $this->session->userdata('jt')=='operator'){ ?>
				<li class="<?php if($this->session->userdata('option')!='dashboard'&&$this->session->userdata('option')!='user'&&$this->session->userdata('option')!='setting') echo 'active';?> treeview">
				  ...
				  <ul class="treeview-menu">
					<?php if($this->session->userdata('jt')=='admin' || $this->session->userdata('jt')=='operator'){?>
					<li <?php if($this->session->userdata('option')=='wisata') echo 'class="active"';?>><a href="<?php echo site_url('dashboard/wisata')?>"><i class="fa fa-map-marker"></i> Wisata</a></li>
					<li <?php if($this->session->userdata('option')=='jenis') echo 'class="active"';?>><a href="<?php echo site_url('dashboard/jenis')?>"><i class="fa fa-tags"></i> Jenis Wisata</a></li>
					<li <?php if($this->session->userdata('option')=='event') echo 'class="active"';?>><a href="<?php echo site_url('dashboard/event')?>"><i class="fa fa-plug"></i> Event</a></li>
					<?php } ?>
				  </ul>
				</li>
					...
					<div class="row">
						...
						<div class="col-lg-3 col-xs-6">
						  ...
						  <div class="small-box bg-red">
							<div class="inner">
							  <h3><?php echo $this->session->userdata('jml_jenis');?></h3>
						...
						<div class="col-lg-3 col-xs-6">
						  ...
						  <div class="small-box bg-yellow">
							<div class="inner">
							  <h3><?php echo $this->session->userdata('jml_event');?></h3>
							...
							<a href="<?php echo site_url('dashboard/event')?>" class="small-box-footer">
							  Detail <i class="fa fa-arrow-circle-right"></i>
							</a>
						  </div>
						</div>
